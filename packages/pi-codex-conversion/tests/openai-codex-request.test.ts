...
test("Codex provider lifecycle and request serialization preserve provider and strict-schema contracts", () => {
	// FORK_MOD: provider removal must expose stock Pi and permit the same adapter provider to return.
